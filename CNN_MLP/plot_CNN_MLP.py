...
from CNN_MLP.DNN import get_DNN
from CNN_MLP.lossCalculator import Loss

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='MLP/CNN plotting')

    #CNN MLP
    parser.add_argument('--dataset_name', type=str, help='cifar10')
    parser.add_argument('--model_name', type=str, help='cnn or mlp')
    ...
    for i in range(trajectory_models.shape[0]):
        ...
        model_repopulated = repopulate_model(model_flattened, get_DNN(dataset_name, model_name, device))
