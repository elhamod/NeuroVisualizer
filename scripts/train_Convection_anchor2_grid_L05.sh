...
#variables
wheretosave=Convection_anchor2_grid_L05
weights="--lastzero_weight 100 --gridscaling_weight 1.0 --latentfactor 0.5 --grid_step 0.2"
...
do
    python plot_Convection.py --model_file /home/elhamod/projects/deepxdeplayground/AE/saved_models/$wheretosave/model.pt --model_folder $models_path --vlevel $vlevel --vmin $vmin --vmax $vmax --x=$x --whichloss $whichloss --layers "2, 50, 50, 50, 50, 1" --activation tanh --nt 251 --N_f 10000 --beta $beta --xgrid 512 --u0_str "sin(x)" --key_models $key_models --key_modelnames $key_modelnames $density $everynth
done
