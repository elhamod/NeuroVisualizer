...
models_path=/home/elhamod/projects/characterizing-pinns-failure-modes/pbc_examples/saved_models/L_Beta30
...
ls=(0.001 1e-05 1e-06) #(0.1  #(10.0 0.1 0.001 1e-05 1e-06)
betas=(30.0)
...
do
    ...
    do
        ...
        do   
            python plot_PINN_Failures.py --model_file /home/elhamod/projects/deepxdeplayground/AE/saved_models/$wheretosave/beta$beta\_L$L/model.pt --model_folder $models_path/beta$beta\_L$L --vlevel $vlevel --vmin $vmin --vmax $vmax --x=$x --whichloss $whichloss $everynth --L $L --beta $beta --key_models $key_models --key_modelnames "L=$L" #--density_type CKA 
        done
    done
done
